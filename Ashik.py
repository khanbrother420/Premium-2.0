#Sc Make By Asraful Islam ASHIK
#Gift By ASHIK
#Github= KgASHIK
...
logo = ("""
\033[1;36m  .d8b.  .d8888. db   db d888888b db   dD 
\033[1;93m 8' `8b 88'  YP  88   88   `88'   88 ,8P'  \033[1;33m𝗡\033[1;37m
\033[1;34m 88ooo88 `8bo.   88ooo88    88    88,8P    \033[1;34m𝗢\033[1;37m
\033[1;33m 88~~~88   `Y8b. 88~~~88    88    88`8b    \033[1;35m𝗢\033[1;37m
\033[1;91m 88   88 db   8D 88   88   .88.   88 `88.  \033[1;36m𝗕\033[1;37m
\033[1;36m YP   YP `8888Y' YP   YP Y888888P YP   YD
         
 \033[1;93m×××××××××××××××××\033[1;93m××××××××××××××\033[1;93m×××××××××××××××××
 \033[1;93m|     \033[1;32m[✓] FACEBOK      : \033[1;34m ASHIK CHOWDHURY      \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] GITHUB       :  \033[1;35mRX-ASHIK             \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL STATUS  : \033[1;36m NUMBER + NAME + EMAIL\033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m2.0                  \033[1;93m|
 \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m×××××××××××××××××""")
...
def asha():
    ...
    with ThreadPool(max_workers=30) as raifa:
        ...
        print('[+] Save As /sdcard/ASHIK-ok.txt')
        print('[!] Save As /Sdacrd/ASHIK-cp.txt')
...
def sabina(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[ASHIK] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
            sys.stdout.flush()
